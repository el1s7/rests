...
;
const fetchAPI = (typeof window !== 'undefined') ? window === null || window === void 0 ? void 0 : window.fetch : require("node-fetch"), formAPI = (typeof window !== 'undefined') ? window === null || window === void 0 ? void 0 : window.FormData : require("form-data"), fsAPI = (typeof window !== 'undefined') ? undefined : require("fs");
if (!fetchAPI) {
