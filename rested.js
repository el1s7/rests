...
function Rested(fetch, FormData, fs, endpoints, global_options){
	...
	var default_global = {
		...
		"sender": false, //Use a custom function to send request -> custom_fetch(url, options, Rested_options, response_middleware?)
...
(function (root, factory) {
    ...
    return Rested.bind(null, fetch, FormData, fs);
}));
